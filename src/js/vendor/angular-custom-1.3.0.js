...
(function(window, document, undefined) {'use strict';
  ...
  var renamed = "cangular"; // custom-angular
...
var /** holds major version number for IE or NaN for real browsers */
    ...
    /** @name angular */
    angular           = window[renamed] || (window[renamed] = {}),
    angularModule,
    uid               = 0;
...
var ngAttrPrefixes = ['cng-', 'data-cng-', 'cng:', 'x-cng-'];
...
function setupModuleLoader(window) {
  ...
  var angular = ensure(window, renamed, Object);
...
function $HttpBackendProvider() {
  this.$get = ['$browser', '$window', '$document', function($browser, $window, $document) {
    return createHttpBackend($browser, createXhr, $browser.defer, $window[renamed].callbacks, $document[0]);
  }];
}
      ...
      if (absHref && !elm.attr('target') && !event.isDefaultPrevented()) {
        if ($location.$$parseLinkUrl(absHref, relHref)) {
          ...
          if ($location.absUrl() != $browser.url()) {
            ...
            window[renamed]['ff-684208-preventDefault'] = true;
          }
        }
      }
    });
...
!window.cangular.$$csp() && window.cangular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>');